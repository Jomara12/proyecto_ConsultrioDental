...
$sql="SELECT * FROM dentista WHERE doctorid='$id'";
    ...
    <body>
                <div class="container mt-5">
                    <form action="update.php" method="POST">
                                ...
                                <input type="text" class="form-control mb-3" name="doctorid" placeholder="Codigo del Dentista" value="<?php echo $row['doctorid']  ?>">
